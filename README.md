...
- Раздел поддержки:
  ...
  - переписка в чате;
  - polling/AJAX-обновление сообщений.
...
На момент обновления этого README локально проходит `19` тестов:
...
- в чате есть простейший антиспам-лимит;
...
6. Прод целиком зависит от корректных внешних env-переменных и внешних сервисов.
7. Медиа в проде нельзя хранить в контейнере Render, только во внешнем storage.
